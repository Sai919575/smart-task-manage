...
public class TaskController {
	    ...
	    public ResponseEntity<Task> updateTask(@PathVariable(value = "id") Long task_id,
	    	...
	    	Task task = taskRepository.findById(task_id)
	        .orElseThrow(() -> new ResourceNotFoundException("Manager not found for this id :: " + task_id));

	    	task.setTask_name(taskDetails.getTask_name());
	    	task.setTask_description(taskDetails.getTask_description());
	    	task.setTask_status(taskDetails.isTask_status());
	    ...
	    public Map<String, Boolean> deleteTask(@PathVariable(value = "id") Long task_id)
	         throws ResourceNotFoundException {
	        Task task = taskRepository.findById(task_id)
	       .orElseThrow(() -> new ResourceNotFoundException("Manager not found for this id :: " + task_id));
